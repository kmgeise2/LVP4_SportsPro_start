...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LVP4_SportsPro_start.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("LVP4_SportsPro_start.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("LVP4_SportsPro_start.Models.Incident", b =>
                {
            ...
            modelBuilder.Entity("LVP4_SportsPro_start.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LVP4_SportsPro_start.Models.Registration", b =>
                {
                    b.Property<int>("CustomerID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LVP4_SportsPro_start.Models.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LVP4_SportsPro_start.Models.Customer", b =>
                {
                    b.HasOne("LVP4_SportsPro_start.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("LVP4_SportsPro_start.Models.Incident", b =>
                {
                    b.HasOne("LVP4_SportsPro_start.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LVP4_SportsPro_start.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LVP4_SportsPro_start.Models.Technician", "Technician")
                        .WithMany()
